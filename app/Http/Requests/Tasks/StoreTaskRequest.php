...
class StoreTaskRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', \App\Models\Tasks\Task::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'recurrence_pattern' => 'nullable|array|required_if:is_recurring,true',
    ...
    {
        return [
            'planned_end_date.after_or_equal' => 'The end date must be on or after the start date.',
            'planned_start_date.after_or_equal' => 'The start date must be today or a future date.',
        ];
    }
}
