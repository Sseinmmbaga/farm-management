    ...
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-home me-2"></i> Villages Management
                </h4>
                <div>
                    ...
                    <tbody>
                        @forelse($villages as $village)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('districts.show', $village->district) }}">{{ $village->district->name }}</a>
                                </td>
                                <td>
                                    <a href="{{ route('regions.show', $village->region) }}">{{ $village->region->name }}</a>
                                </td>
                                <td class="text-center"><span class="badge bg-info">{{ $village->subvillages_count }}</span></td>
                                <td class="text-center"><span class="badge bg-primary">{{ $village->farmers_count }}</span></td>
                                <td class="text-center"><span class="badge bg-success">{{ $village->farms_count }}</span></td>
