...
@section('title', 'Create Subvillage')
            ...
            <div class="card shadow">
                <div class="card-header bg-info text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-plus-circle me-2"></i> Create New Subvillage
                        </h4>
                        <a href="{{ route('subvillages.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('subvillages.store') }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('subvillages.index') }}" class="btn btn-secondary">
                                <i class="fas fa-times me-1"></i> Cancel
                            </a>
                            <button type="submit" class="btn btn-info">
                                <i class="fas fa-save me-1"></i> Create Subvillage
                            </button>
                        </div>
                    </form>
                </div>
