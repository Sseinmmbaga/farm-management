            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-calendar-plus me-2"></i> Schedule Training Session
                        </h4>
                        <a href="{{ route('training.upcoming') }}" class="btn btn-light btn-sm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('trainer_organization') }}">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('training.upcoming') }}" class="btn btn-secondary">
                                        <i class="fas fa-times me-1"></i> Cancel
                                    </a>
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i> Schedule Session
                                    </button>
                                </div>
                            </div>
                        </div>
