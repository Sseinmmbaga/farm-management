            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-plus-circle me-2"></i> Add Training Program
                        </h4>
                        <a href="{{ route('training-programs.index') }}" class="btn btn-light btn-sm">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('code') }}"
                                           required>
                                    <small class="text-muted">Unique identifier for the program (e.g., TP-001)</small>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror"
                                        ...
                                        <option value="organic_farming" {{ old('category') == 'organic_farming' ? 'selected' : '' }}>Organic Farming</option>
                                        <option value="pest_management" {{ old('category') == 'pest_management' ? 'selected' : '' }}>Pest Management</option>
                                        <option value="harvest" {{ old('category') == 'harvest' ? 'selected' : '' }}>Harvest Techniques</option>
                                        <option value="soil_management" {{ old('category') == 'soil_management' ? 'selected' : '' }}>Soil Management</option>
                                        <option value="water_management" {{ old('category') == 'water_management' ? 'selected' : '' }}>Water Management</option>
                                        <option value="business_skills" {{ old('category') == 'business_skills' ? 'selected' : '' }}>Business Skills</option>
