...
@section('title', 'Edit Training Material')
            ...
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-edit me-2"></i> Edit Training Material
                        </h4>
                        <a href="{{ route('training.materials.show', $material) }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('training.materials.update', $material) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="title_sw"
                                           name="title_sw"
                                           value="{{ old('title_sw', $material->title_sw) }}">
                                    @error('title_sw')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror"
                                                ...
                                                <option value="handout" {{ old('type', $material->type) == 'handout' ? 'selected' : '' }}>Handout</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('language') is-invalid @enderror"
                                                    id="language"
                                                    name="language">
                                                <option value="sw" {{ old('language', $material->language) == 'sw' ? 'selected' : '' }}>Swahili</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('training_program_id') is-invalid @enderror"
                                        ...
                                        @foreach($programs as $program)
                                            <option value="{{ $program->id }}" {{ old('training_program_id', $material->training_program_id) == $program->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('training_session_id') is-invalid @enderror"
                                        ...
                                        @foreach($sessions as $session)
                                            <option value="{{ $session->id }}" {{ old('training_session_id', $material->training_session_id) == $session->id ? 'selected' : '' }}>
                                ...
                                @if($material->file_path)
                                    <div class="alert alert-info">
                                        ...
                                        <br>{{ basename($material->file_path) }}
                                        <br><small>Size: {{ $material->file_size_formatted }}</small>
                                    </div>
                                @endif
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('training.materials.show', $material) }}" class="btn btn-secondary">
