...
@section('title', 'Farmer History - New Farm Records (Form 2)')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-history text-success"></i> Farmer History - New Farm Records (Form 2)</h2>
    ...
    <div class="card">
        <div class="card-header bg-white">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0"><i class="fas fa-users"></i> Farmers with New Farm Records</h5>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-hover" id="farmersTable">
                        ...
                        <tbody>
                            @foreach($farmers as $index => $farmer)
                                @php
                                    $newRecordsCount = $farmer->farms->sum(function($farm) {
                                        return $farm->farmRecords->where('record_type', 'new')->count();
                                    });
                                @endphp
                                <tr class="farmer-row">
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>
                                        <span class="badge bg-success">{{ $newRecordsCount }}</span>
                                    </td>
