...
@section('title', 'Resolved Findings')
            ...
            <div class="card">
                <div class="card-header bg-success text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-check-circle me-2"></i> Resolved Findings
                        </h4>
                        <div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="card border-info">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="text-muted mb-1">Resolved This Month</h6>
                                            <h3 class="mb-0">{{ $findings->where('resolved_at', '>=', now()->startOfMonth())->count() }}</h3>
                                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="card border-warning">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="text-muted mb-1">Average Resolution Time</h6>
                                            <h3 class="mb-0">{{ $findings->avg('days_to_resolve') ?? 0 }} days</h3>
                                        </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($findings as $finding)
                                    <tr>
                                        <td>
                                            <strong class="text-success">{{ $finding->finding_number }}</strong>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if($finding->resolved_at)
                                                {{ $finding->resolved_at->format('M d, Y') }}
                                                <br>
                                                <small class="text-muted">{{ $finding->resolved_at->diffForHumans() }}</small>
                                            @else
                                                <span class="text-muted">Not recorded</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if($finding->resolved_at && $finding->created_at)
                                                {{ $finding->created_at->diffInDays($finding->resolved_at) }} days
                                            @else
                                                -
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <form action="{{ route('findings.reopen', $finding) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline-danger" title="Reopen Finding">
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-4">
                                            <div class="text-muted">
                                                ...
                                                <h5>No resolved findings</h5>
                                                <p>No findings have been resolved yet.</p>
                                                <a href="{{ route('findings.open') }}" class="btn btn-success">
