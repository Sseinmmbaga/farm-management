...
@section('title', 'Add Compliance Standard')
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-plus-circle me-2"></i> Add New Compliance Standard
                        </h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="organic" {{ old('category') == 'organic' ? 'selected' : '' }}>Organic</option>
                                        <option value="fair_trade" {{ old('category') == 'fair_trade' ? 'selected' : '' }}>Fair Trade</option>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i> Save Standard
                                    </button>
                                </div>
                            </div>
                        </div>
