...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-calendar-plus text-primary"></i> Add New Season</h2>
            ...
            <form method="POST" action="{{ route('seasons.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="3"
                              placeholder="Any additional notes about this season...">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Save Season
                    </button>
                </div>
            </form>
        </div>
