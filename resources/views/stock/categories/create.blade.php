...
@section('title', 'Add New Stock Category')
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-tag me-2"></i> Add New Stock Category
                        </h4>
                        <a href="{{ route('stock-categories.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('stock-categories.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5 class="mb-3 border-bottom pb-2">
                                    <i class="fas fa-sitemap me-2"></i> Hierarchy & Settings
                                </h5>
